...
@section('page-title', 'Valoraciones de Pacientes')
...
<div class="grid grid-cols-1 gap-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-800">{{ $estadisticas['promedio'] }}</p>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-50">
            <h3 class="font-bold text-gray-800">Valoraciones Recibidas</h3>
            <p class="text-sm text-gray-500 mt-1">Comentarios y calificaciones de tus pacientes.</p>
        </div>
        ...
        <div class="divide-y divide-gray-50">
                    ...
                    <div class="flex items-start justify-between gap-4 mb-3">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                <p class="text-sm font-bold text-gray-800">{{ $valoracion->cita->paciente->usuario->nombre ?? 'Paciente no encontrado' }}</p>
            ...
            @empty
                <div class="px-6 py-16 text-center">
                    ...
                    <p class="text-gray-500 font-medium text-lg">Aún no has recibido valoraciones</p>
                    <p class="text-gray-400 text-sm mt-2">
                        Las valoraciones aparecerán aquí después de que tus pacientes completen sus citas.
                    </p>
                </div>
            @endforelse
        </div>
