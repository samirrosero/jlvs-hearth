            ...
            @php
                $nav = [
                    ...
                    [
                        'route' => 'medico.agenda',
                        'match' => 'medico.agenda*',
                        'icon'  => $empresa?->icono_medico_agenda_url ?: null,
                        'svg'   => $empresa?->icono_medico_agenda_url ? null : '<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>',
                        'label' => 'Mi Agenda',
                    ],
                    [
                        'route' => 'medico.citas',
                    ...
                    [
                        'route' => 'medico.valoraciones',
                        'match' => 'medico.valoraciones*',
                        'svg'   => '<svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>',
                        'label' => 'Mis Valoraciones',
                    ],
                    [
                        'route' => 'medico.horario',
                        'match' => 'medico.horario*',
                        'icon'  => $empresa?->icono_medico_horario_url ?: null,
                        'svg'   => $empresa?->icono_medico_horario_url ? null : '<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>',
                        'label' => 'Mi Horario',
                    ],
                    [
                        'route' => 'medico.ordenes',
                        'match' => 'medico.ordenes*',
                        'icon'  => $empresa?->icono_medico_ordenes_url ?: null,
                        'svg'   => $empresa?->icono_medico_ordenes_url ? null : '<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>',
                        'label' => 'Órdenes Emitidas',
                    ],
                    [
                        'route' => 'medico.perfil',
                        'match' => 'medico.perfil*',
                        'icon'  => $empresa?->icono_medico_perfil_url ?: null,
                        'svg'   => $empresa?->icono_medico_perfil_url ? null : '<svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>',
                        'label' => 'Mi Perfil',
                    ],
                ];
            @endphp
