...
@section('content')
    <div class="max-w-xl mx-auto space-y-5">
        ...
        <div class="relative flex items-center justify-center py-2">
            ...
            <h2 class="text-xl font-bold text-gray-900 text-center">Nuevo paciente</h2>
        </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-5 gap-3">
                        <div class="col-span-2">
                            ...
                            <select id="tipo_documento" name="tipo_documento" required
                                ...
                                <option value="CC" {{ old('tipo_documento') === 'CC' ? 'selected' : '' }}>CC — Cédula
                                    ciudadanía</option>
                                <option value="TI" {{ old('tipo_documento') === 'TI' ? 'selected' : '' }}>TI — Tarjeta
                                    identidad</option>
                                <option value="CE" {{ old('tipo_documento') === 'CE' ? 'selected' : '' }}>CE — Cédula
                                    extranjería</option>
                                <option value="PA" {{ old('tipo_documento') === 'PA' ? 'selected' : '' }}>PA —
                                    Pasaporte</option>
                                <option value="RC" {{ old('tipo_documento') === 'RC' ? 'selected' : '' }}>RC — Registro
                                    civil</option>
                        ...
                        <div class="col-span-3">
                            ...
                            <input type="text" id="identificacion" name="identificacion"
                                value="{{ old('identificacion') }}" placeholder="Ej. 1004567890" required
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="nombres" name="nombres" value="{{ old('nombres') }}"
                                placeholder="Ej. María Camila" required
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none
                    ...
                    <div>
                        ...
                        <input type="email" id="correo" name="correo" value="{{ old('correo') }}"
                            placeholder="paciente@ejemplo.com" required
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none
