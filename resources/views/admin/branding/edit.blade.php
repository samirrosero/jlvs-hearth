    ...
    <form method="POST" action="{{ route('admin.branding.update') }}" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100">
                ...
                <p class="text-xs text-gray-400 mt-0.5">Iconos exclusivos del menú lateral que ve el gestor de citas. Independientes del panel administrativo. PNG, SVG o WEBP · máx. 512 KB.</p>
            </div>
            <div class="p-6">
